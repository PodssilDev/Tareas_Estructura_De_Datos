...
Crear un programa que lea dos archivos y entregue otro intercalando los caracteres de cada archivo 
*/
// PARA ESTE EJERCICIO SE ASUME QUE AMBOS ARCHIVOS TIENEN EL MISMO LARGO
#include <stdio.h>
int main(){
